          ...
          <tr>
            ...
            <td>
              <c:url value="RepositorySearch" var="urlPreLocked">
                ...
                <c:param name="statement" value="/jcr:root/${root}//element(*,openkm:document)[@jcr:lockOwner]/@jcr:lockOwner"/>
              </c:url>
              <c:url value="RepositorySearch" var="urlPreCreated">
                <c:param name="type" value="xpath"/>
                <c:param name="statement" value="/jcr:root/${root}//element(*, openkm:document)[@openkm:author='dmsAdmin']/(@jcr:lockOwner|@jcr:created)"/>
              </c:url>
              ...
              <c:url value="RepositorySearch" var="urlPreSubscription">
                <c:param name="type" value="xpath"/>
                <c:param name="statement" value="/jcr:root/${root}//element(*, mix:notification)/@openkm:subscriptors"/>
              </c:url>
              <a href="${urlPreLocked}">Locked documents</a>
              -
              <a href="${urlPreCreated}">Documents created by 'dmsAdmin'</a>
              -
