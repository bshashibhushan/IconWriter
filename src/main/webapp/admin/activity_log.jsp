  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <table class="results" width="95%">
        <thead>
          <tr><th>Date</th><th>User</th><th>Action</th><th>Item</th><th>Path</th><th>Parameters</th>
           <th width="50px">
           <c:url value="ExportActivityLog" var="urlExport">
                <c:param name="action" value="export"/>
              </c:url>
             <a href="${urlExport}"><img src="img/action/export.png" alt="Export Activity log" title="Export Activity log"/></a>
            </th>
          </tr>
        </thead>
        <tbody>
