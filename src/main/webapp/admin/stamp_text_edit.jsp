...
<body>
  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <ul id="breadcrumb">
        <li class="path">
          <a href="${urlTextList}">Text stamp list</a>
        </li>
        <li class="path">
          <c:choose>
            <c:when test="${action == 'textCreate'}">Create text stamp</c:when>
            <c:when test="${action == 'textEdit'}">Edit text stamp</c:when>
            <c:when test="${action == 'textDelete'}">Delete text stamp</c:when>
          </c:choose>
        </li>
      </ul>
      <br/>
