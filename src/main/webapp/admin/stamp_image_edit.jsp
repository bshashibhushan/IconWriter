...
<body>
  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <ul id="breadcrumb">
        <li class="path">
          <a href="${urlImageList}">Image stamp list</a>
        </li>
        <li class="path">
          <c:choose>
            <c:when test="${action == 'imageCreate'}">Create image stamp</c:when>
            <c:when test="${action == 'imageEdit'}">Edit image stamp</c:when>
            <c:when test="${action == 'imageDelete'}">Delete image stamp</c:when>
          </c:choose>
        </li>
      </ul>
      <br/>
