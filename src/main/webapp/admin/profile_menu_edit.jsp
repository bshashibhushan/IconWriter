...
<fieldset>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.prfToolbar.annotateVisible}">
            <input name="prf_toolbar_annotate_visible" type="checkbox" checked="checked"/>
          </c:when>
          <c:otherwise>
            <input name="prf_toolbar_annotate_visible" type="checkbox"/>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.prfToolbar.signVisible}">
            <input name="prf_toolbar_sign_visible" type="checkbox" checked="checked"/>
          </c:when>
          <c:otherwise>
            <input name="prf_toolbar_sign_visible" type="checkbox"/>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
     <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.prfToolbar.stampVisible}">
            <input name="prf_toolbar_stamp_visible" type="checkbox" checked="checked"/>
          </c:when>
          <c:otherwise>
            <input name="prf_toolbar_stamp_visible" type="checkbox"/>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
