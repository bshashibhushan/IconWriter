...
<%@ page import="com.ikon.frontend.client.bean.GWTUINotification" %>
...
<body>
  ...
  <u:constantsMap className="com.ikon.frontend.client.bean.GWTUINotification" var="GWTUINotification"/>
  <c:choose>
    <c:when test="${isAdmin}">
