...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			<ul id="breadcrumb">
				<li class="path"><a href="backup_utilities.jsp">backup utility</a></li>
			</ul>
			<br />
			...
			<div id="ftpCntr">
				<form action="BackupUtil?action=ftp" method="post">
					<table class="form" width="372px">
						<tr>
							<td width="80px;">ServerID:</td>
							<td><INPUT TYPE="TEXT" NAME="serverId" required autofocus
								oninvalid="setCustomValidity('Please enter your server Id.')"
			...
			<div id="storageCntr" style="display: none;">
				<form action="BackupUtil?action=storage" method="post">
					<table class="form" width="372px">
						<tr>
							<td>Destination path</td>
							<td><INPUT type="text" NAME="storagePath" value="" required autofocus
								oninvalid="setCustomValidity('Please enter backup dest.')"
								onchange="try{setCustomValidity('')}catch(e){}"></td>
						</tr>
						<tr>
							<td width="80px;">&nbsp;</td>
