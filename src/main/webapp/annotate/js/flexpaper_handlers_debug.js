...
function chainOfMethods(){
	...
	viewer.addMark({type:'note', note: 'The plug-in features a full set of API functions which can be used to interact with the viewer so that annotations can be stored and recreated later.',positionX:300,positionY:350,width:200,height:180,pageIndex:3,collapsed:true,displayFormat:'html'});
