...
<%@ page import="com.ikon.dao.LanguageDAO"%>
<%@ page import="com.ikon.dao.bean.Language"%>
<%@ page import="com.ikon.dao.HibernateUtil"%>
...
<head>
  ...
  %>
  <title>Welcome to Infodocs</title>
</head>
<body onload="document.forms[0].elements[0].focus()">
<%-- <c:choose>
 <c:when test="${not empty DAYS_LEFT }"> --%>
  <u:constantsMap className="com.ikon.core.Config" var="Config"/>
  <div id="box">
    <div id="logo"></div>
    <div id="error">
      <c:if test="${not empty param.error}">
        Authentication error
        <c:if test="${Config.PRINCIPAL_ADAPTER == 'com.ikon.principal.DatabasePrincipalAdapter'}">
    ...
    <div id="text">
      ...
      <p>Welcome to Infodocs</p>
      <p>Use a valid username and password to access to Infodocs user Desktop.</p>
      <p>${DAYS_LEFT }</p>
    </div>
    <div id="form">
