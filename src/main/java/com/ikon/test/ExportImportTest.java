...
public class ExportImportTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// Export system view
		seOld.exportSystemView("/openkm:root", new FileOutputStream("okmRootSysView.xml"), false, false);
		...
		Node okmRootNew = seNew.getRootNode().getNode("openkm:root");
	...
	public static Node createRoot(Session session) throws Exception {
		...
		Node okmRoot = root.addNode("openkm:root", "nt:folder");
		okmRoot.addMixin("mix:referenceable");
		session.save();
		System.out.println("openkm:root created.");
		return okmRoot;
	}
}
