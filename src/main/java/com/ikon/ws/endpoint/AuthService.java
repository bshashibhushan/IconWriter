...
import com.ikon.module.AuthModule;
import com.ikon.module.ModuleManager;
import com.ikon.principal.PrincipalAdapterException;
import com.ikon.ws.util.IntegerPair;

@WebService(name = "eArchiDocAuth", serviceName = "eArchiDocAuth", 
             targetNamespace = "http://ws.earchidoc.com")
