...
import com.ikon.module.WorkflowModule;
import com.ikon.ws.util.FormElementComplex;

@WebService(name = "eArchiDocWorkflow", serviceName = "eArchiDocWorkflow", targetNamespace = "http://ws.earchidoc.com")
