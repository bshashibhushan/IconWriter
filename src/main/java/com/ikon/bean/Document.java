...
public class Document implements Serializable {
	...
	public static final String TYPE = "openkm:document";
	public static final String CONTENT = "openkm:content";
	public static final String CONTENT_TYPE = "openkm:resource";
	public static final String SIZE = "openkm:size";
	public static final String LANGUAGE = "openkm:language";
	public static final String AUTHOR = "openkm:author";
	public static final String VERSION_COMMENT = "openkm:versionComment";
	public static final String NAME = "openkm:name";
	public static final String TEXT = "openkm:text";
	public static final String TITLE = "openkm:title";
	public static final String DESCRIPTION = "openkm:description";
