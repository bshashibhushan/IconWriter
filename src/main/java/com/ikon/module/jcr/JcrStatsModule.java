...
import com.ikon.bean.StatsInfo;
import com.ikon.core.DatabaseException;
import com.ikon.core.RepositoryException;
import com.ikon.module.StatsModule;
...
public class JcrStatsModule implements StatsModule {
	...
	private static String TAXONOMY_DOCUMENTS = "/jcr:root/"+Repository.ROOT+"//element(*,openkm:document)";
	private static String TAXONOMY_FOLDERS = "/jcr:root/"+Repository.ROOT+"//element(*,openkm:folder)";
	private static String TEMPLATES_DOCUMENTS = "/jcr:root/"+Repository.TEMPLATES+"//element(*,openkm:document)";
	private static String TEMPLATES_FOLDERS = "/jcr:root/"+Repository.TEMPLATES+"//element(*,openkm:folder)";
	private static String PERSONAL_DOCUMENTS = "/jcr:root/"+Repository.PERSONAL+"//element(*,openkm:document)";
	private static String PERSONAL_FOLDERS = "/jcr:root/"+Repository.PERSONAL+"//element(*,openkm:folder)";
	private static String TRASH_DOCUMENTS = "/jcr:root/"+Repository.TRASH+"//element(*,openkm:document)";
	private static String TRASH_FOLDERS = "/jcr:root/"+Repository.TRASH+"//element(*,openkm:folder)";
