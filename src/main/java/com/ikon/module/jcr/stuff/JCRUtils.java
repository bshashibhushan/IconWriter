...
import com.ikon.dao.LockTokenDAO;
import com.ikon.dao.bean.LockToken;
import com.ikon.module.jcr.JcrAuthModule;
import com.ikon.module.jcr.JcrRepositoryModule;
import com.ikon.util.EnvironmentDetector;
import com.ikon.util.StackTraceUtils;
...
public class JCRUtils {
	...
	public static long calculateQuota(Session session) throws javax.jcr.RepositoryException {
		// "/jcr:root/openkm:root//element(*, openkm:document)[openkm:content/@openkm:author='"+session.getUserID()+"']";
		String qs = "/jcr:root//element(*, openkm:document)[openkm:content/@openkm:author='"+session.getUserID()+"']";
