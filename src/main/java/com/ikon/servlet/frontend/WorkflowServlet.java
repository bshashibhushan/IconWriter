...
import com.ikon.api.OKMWorkflow;
...
import com.ikon.core.WorkflowException;
...
import com.ikon.util.WorkflowUtils;
...
public class WorkflowServlet extends OKMRemoteServiceServlet implements OKMWorkflowService {
	...
	@Override 
	public int getUserTaskLists(String userId) throws OKMException { 
					// TODO Auto-generated method stub 
			int taskList = 0; 
					 
					try { 
						taskList = WorkflowUtil.getUserTaskLists(userId); 
