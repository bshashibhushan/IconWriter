...
import com.ikon.extension.dao.ExtensionDAO;
...
public class ProfileServlet extends BaseServlet {
	...
	private Profile getUserProfile(HttpServletRequest request) {
		...
		prf.getPrfToolbar().setSignVisible(WebUtils.getBoolean(request, "prf_toolbar_sign_visible"));
		prf.getPrfToolbar().setStampVisible(WebUtils.getBoolean(request, "prf_toolbar_stamp_visible"));
		prf.getPrfToolbar().setAnnotateVisible(WebUtils.getBoolean(request, "prf_toolbar_annotate_visible"));
