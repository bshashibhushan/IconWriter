...
public class PathUtils {
	 ...
	 * TODO Keep on sync with uploader:com.ikon.applet.Util.escape(String)
	 * TODO Keep on sync with wsImporter:com.ikon.importer.Util.escape(String)
	 */
	...
	/**
	 * Fix context definition. For example "/openkm:root" -> "ikon_root"
	 */
