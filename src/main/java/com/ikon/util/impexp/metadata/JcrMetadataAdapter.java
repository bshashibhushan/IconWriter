...
package com.ikon.util.impexp.metadata;
...
import com.ikon.bean.Notification;
...
public class JcrMetadataAdapter extends MetadataAdapter {
	...
	public void importWithMetadata(DocumentMetadata dmd, InputStream is) throws ItemExistsException,
		...
		try {
			...
			documentNode.setProperty(com.ikon.bean.Property.KEYWORDS, getValues(dmd.getKeywords()));
			documentNode.setProperty(com.ikon.bean.Property.CATEGORIES, getValues(session, dmd.getCategories()));
	...
	public void importWithMetadata(FolderMetadata fmd) throws ItemExistsException, RepositoryException,
		...
		try {
			...
			folderNode.setProperty(com.ikon.bean.Property.KEYWORDS, getValues(fmd.getKeywords()));
			folderNode.setProperty(com.ikon.bean.Property.CATEGORIES, getValues(session, fmd.getCategories()));
