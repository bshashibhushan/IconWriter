...
public class DatabaseDialectAdapter {
	...
	private static String oracleAdapter(String line) {
		...
		if (line.startsWith("INSERT INTO ikon_FORUM")) {
			str = line.replaceAll("NOW\\(\\)", "SYSDATE");
		} else if (line.startsWith("INSERT INTO ikon_WIKI_PAGE")) {
			str = line.replaceAll("NOW\\(\\)", "SYSDATE");
		} else {
			str = line;
		}
	...
	private static String sqlServerAdapter(String line) {
		...
		if (line.startsWith("INSERT INTO ikon_PROFILE")) {
			sb.append("SET IDENTITY_INSERT ikon_PROFILE ON;").append("\n");
			sb.append(line).append("\n");
			sb.append("SET IDENTITY_INSERT ikon_PROFILE OFF;");
		} else if (line.startsWith("INSERT INTO ikon_MIME_TYPE")) {
			sb.append("SET IDENTITY_INSERT ikon_MIME_TYPE ON;").append("\n");
			sb.append(line).append("\n");
			sb.append("SET IDENTITY_INSERT ikon_MIME_TYPE OFF;");
		} else if (line.startsWith("INSERT INTO ikon_FORUM")) {
			sb.append("SET IDENTITY_INSERT ikon_FORUM ON;").append("\n");
			sb.append(line.replaceAll("NOW\\(\\)", "GETDATE()")).append("\n");
			sb.append("SET IDENTITY_INSERT ikon_FORUM OFF;");
		} else if (line.startsWith("INSERT INTO ikon_WIKI_PAGE")) {
			sb.append("SET IDENTITY_INSERT ikon_WIKI_PAGE ON;").append("\n");
			sb.append(line.replaceAll("NOW\\(\\)", "GETDATE()")).append("\n");
			sb.append("SET IDENTITY_INSERT ikon_WIKI_PAGE OFF;");
		} else {
			sb.append(line);
		}
