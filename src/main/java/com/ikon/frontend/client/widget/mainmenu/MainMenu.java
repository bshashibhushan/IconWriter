...
public class MainMenu extends Composite {
	...
	public MainMenu() {
		...
		signaturePanel = new MenuItem(Util.menuHTML("img/icon/menu/signature_panel.png", "Signature Panel"), true, signaturePanelBar);
		updateSignature = new MenuItem(Util.menuHTML("img/icon/actions/delete.gif", "update Signature"), true, updateSignatureAction);
	...
	public void langRefresh() {
		...
		signaturePanel.setHTML(Util.menuHTML("img/icon/menu/signature_panel.png",
				"Signature Panel"));
		preferences
