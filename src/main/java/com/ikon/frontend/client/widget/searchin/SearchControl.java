...
package com.ikon.frontend.client.widget.searchin;
...
import com.ikon.frontend.client.constants.ui.UISearchConstants;
import com.ikon.frontend.client.service.OKMSearchService;
import com.ikon.frontend.client.service.OKMSearchServiceAsync;
	...
	public void executeSearch() {
		switch(searchMode) {
			case SEARCH_MODE_SIMPLE:
				...
				controlSearch.executeSearch(searchSimple.fullText.getText().toLowerCase(), Integer.parseInt(resultPage.getItemText(resultPage.getSelectedIndex())));
				break;
			...
			case SEARCH_MODE_ADVANCED:
				...
				gwtParams.setKeywords(searchNormal.keywords.getText().toLowerCase());
