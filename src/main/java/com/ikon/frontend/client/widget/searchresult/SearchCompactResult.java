...
import com.ikon.frontend.client.widget.popup.DocumentRelationPopup;
...
public class SearchCompactResult extends Composite {
	 ...
	 *  document Relate
	 */
	public void documentRelation(GWTDocument doc) {
		if(doc == null)
			new DocumentRelationPopup(getDocument()).show();
		else
			new DocumentRelationPopup(doc).show();
