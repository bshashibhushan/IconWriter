 ...
 */
package com.ikon.frontend.client.widget.upload;
...
import com.ikon.frontend.client.bean.GWTFileUploadResponse;
...
import com.ikon.frontend.client.widget.notify.NotifyPanel;
...
public class FancyFileUpload extends Composite implements HasText, HasChangeHandlers {
	...
	public native void initJavaScriptApi(FancyFileUpload ffu) /*-{
		$wnd.jsWizard = function(docPath, result) {
			ffu.@com.ikon.frontend.client.widget.upload.FancyFileUpload::jsWizard(Ljava/lang/String;Ljava/lang/String;)(docPath, result);
		}
	}-*/;
}
