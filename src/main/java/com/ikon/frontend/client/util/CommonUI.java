...
public class CommonUI {
	...
	public native void initJavaScriptApi(CommonUI commonUI) /*-{
		$wnd.openPathByUuid = function(uuid) { 
			return @com.ikon.frontend.client.util.CommonUI::openPathByUuid(Ljava/lang/String;)(uuid);
		}
		$wnd.openPath = function(folderPath, docPath) {
			@com.ikon.frontend.client.util.CommonUI::openPath(Ljava/lang/String;Ljava/lang/String;)(folderPath, docPath);
			return true;
		};
		...
		$wnd.jsOpenUserTaskInstance = function(taskInstanceId) {
			@com.ikon.frontend.client.util.CommonUI::openUserTaskInstance(Ljava/lang/String;)(taskInstanceId);
			return true;
		};
	}-*/;
}
