...
import com.ikon.frontend.client.service.OKMUINotificationService;
import com.ikon.frontend.client.service.OKMUINotificationServiceAsync;
	...
	final AsyncCallback<GWTWorkspace> callbackGetUserWorkspace = new AsyncCallback<GWTWorkspace>() {
		public void onSuccess(GWTWorkspace result) {
			...
			if (workspace.isTabDocumentPropertiesVisible()) {
				...
				Main.get().mainPanel.desktop.browser.tabMultiple.tabDocument.showStaple();
			}
