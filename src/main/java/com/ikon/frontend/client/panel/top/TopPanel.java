...
package com.ikon.frontend.client.panel.top;
...
import com.ikon.frontend.client.widget.TabWorkspace;
...
public class TopPanel extends Composite {
	...
	public TopPanel() {
		...
		signOut = new HTML(Main.i18n("Sign Out"));
		signOut.setWidth("50");
		signOut.setStyleName("okm-Hyperlink");
		...
		quickSearchPanel.setCellVerticalAlignment(signOut, HasAlignment.ALIGN_MIDDLE);
		
		smallLogo = new Image("img/writer.jpg");
		smallLogo.setHeight("20px");
		
		quickSearchPanel.add(smallLogo);
		...
		/*Image logo = new Image("img/logo_ikon_tiny.gif");
