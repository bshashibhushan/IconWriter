...
public class GWTAvailableOption implements IsSerializable {
	...
	private boolean annotateOption = true;
	private boolean signOption = true;
	private boolean stampOption = true;
	...
	public boolean isAnnotateOption() {
		return annotateOption;
	}

	public void setAnnotateOption(boolean annotateOption) {
		this.annotateOption = annotateOption;
	}
	
	public boolean isSignOption() {
		return signOption;
	}
	...
	public boolean isStampOption() {
		return stampOption;
	}

	public void setStampOption(boolean stampOption) {
		this.stampOption = stampOption;
	}
