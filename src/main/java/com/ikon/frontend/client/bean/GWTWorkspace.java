...
public class GWTWorkspace implements IsSerializable {
	...
	private boolean isSignConfigured = false;
	...
	public boolean isSignConfigured() {
		return isSignConfigured;
	}

	public void setSignConfigured(boolean isSignConfigured) {
		this.isSignConfigured = isSignConfigured;
	}
