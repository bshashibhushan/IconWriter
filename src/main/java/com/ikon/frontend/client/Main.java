...
package com.ikon.frontend.client;
...
import com.ikon.frontend.client.bean.GWTUserConfig;
import com.ikon.frontend.client.bean.RepositoryContext;
...
import com.ikon.frontend.client.extension.event.hashandler.HasLanguageHandlerExtension;
import com.ikon.frontend.client.panel.ExtendedDockPanel;
...
import com.ikon.frontend.client.service.OKMFolderServiceAsync;
import com.ikon.frontend.client.service.OKMLanguageService;
import com.ikon.frontend.client.service.OKMLanguageServiceAsync;
import com.ikon.frontend.client.service.OKMMailService;
import com.ikon.frontend.client.service.OKMMailServiceAsync;
import com.ikon.frontend.client.service.OKMRepositoryService;
import com.ikon.frontend.client.service.OKMRepositoryServiceAsync;
import com.ikon.frontend.client.util.CommonUI;
import com.ikon.frontend.client.util.ConversionStatus;
import com.ikon.frontend.client.util.Location;
import com.ikon.frontend.client.util.Util;
import com.ikon.frontend.client.util.WindowUtils;
import com.ikon.frontend.client.util.WorkspaceUserProperties;
import com.ikon.frontend.client.widget.AboutPopup;
import com.ikon.frontend.client.widget.ConfirmPopup;
import com.ikon.frontend.client.widget.DebugConsolePopup;
import com.ikon.frontend.client.widget.Dragable;
import com.ikon.frontend.client.widget.ErrorPopup;
import com.ikon.frontend.client.widget.ExternalURLPopup;
import com.ikon.frontend.client.widget.LogoutPopup;
import com.ikon.frontend.client.widget.MsgPopup;
import com.ikon.frontend.client.widget.PreviewPopup;
import com.ikon.frontend.client.widget.ReportPopup;
import com.ikon.frontend.client.widget.TemplatePopup;
import com.ikon.frontend.client.widget.UserPopup;
import com.ikon.frontend.client.widget.WorkflowPopup;
import com.ikon.frontend.client.widget.chat.OnlineUsersPopup;
import com.ikon.frontend.client.widget.finddocument.FindDocumentSelectPopup;
import com.ikon.frontend.client.widget.findfolder.FindFolderSelectPopup;
import com.ikon.frontend.client.widget.foldertree.FolderTree;
import com.ikon.frontend.client.widget.notify.NotifyPopup;
import com.ikon.frontend.client.widget.popup.CategoriesPopup;
import com.ikon.frontend.client.widget.popup.KeywordsPopup;
import com.ikon.frontend.client.widget.popup.NotesPopup;
import com.ikon.frontend.client.widget.popup.OmrPopup;
import com.ikon.frontend.client.widget.popup.PropertyGroupPopup;
import com.ikon.frontend.client.widget.popup.RegisterPFXPopup;
import com.ikon.frontend.client.widget.popup.RetentionPolicyPopup;
import com.ikon.frontend.client.widget.popup.StampPopup;
import com.ikon.frontend.client.widget.security.SecurityPopup;
import com.ikon.frontend.client.widget.startup.StartUp;
import com.ikon.frontend.client.widget.startup.StartUpPopup;
import com.ikon.frontend.client.widget.test.TestPopup;
import com.ikon.frontend.client.widget.upload.FileUploadPopup;
import com.ikon.frontend.client.widget.wizard.TemplateWizardPopup;
import com.ikon.frontend.client.widget.wizard.WizardPopup;
...
public final class Main implements EntryPoint, HasLanguageHandlerExtension, HasLanguageEvent {
	...
	public ErrorPopup errorPopupServer;
	...
	public RegisterPFXPopup registerPFXPopup;
	public PreviewPopup previewPopup;
	public RetentionPolicyPopup retentionPolicyPopup;
	public StampPopup stampPopup;
	...
	public void showError(String callback, Throwable caught) {
		...
		if (caught instanceof OKMException) {
			...
			Main.get().mainPanel.bottomPanel.setStatus(callback + ":" + okme.getMessage());
			...
			if (!Main.get().windowClosing) {
				errorPopupServer.serverErrorShow(Main.i18n("error.invocation"));
			}
			...
			Main.get().mainPanel.bottomPanel.setStatus(callback + ":" + caught.getMessage());
	...
	native void initJavaScriptApi() /*-{
		...
		$wnd.i18n = function(s) {
			return @com.ikon.frontend.client.Main::i18n(Ljava/lang/String;)(s);
		};
