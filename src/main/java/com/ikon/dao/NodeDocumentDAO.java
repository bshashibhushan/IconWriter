...
import com.ikon.extractor.TextExtractorWork;
...
public class NodeDocumentDAO {
	 ...
	 * Delete document
	 */
	public void delete(String name, String uuid, String trashUuid, String docPath) throws PathNotFoundException,
	 ...
	 * 
	 * @see com.ikon.dao.NodeFolderDAO.purgeHelper(Session, NodeFolder, boolean)
	 * @see com.ikon.dao.NodeMailDAO.purgeHelper(Session, NodeMail)
	 */
	@SuppressWarnings("unchecked")
