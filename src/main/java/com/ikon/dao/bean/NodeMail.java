...
public class NodeMail extends NodeBase {
	...
	@CollectionTable(name = "ikon_NODE_MAIL_REPLY", joinColumns = { @JoinColumn(name = "NMT_NODE") })
	@Field(index = Index.TOKENIZED, store = Store.YES)
	...
	@ElementCollection
	@Column(name = "NML_TO")
	@CollectionTable(name = "ikon_NODE_MAIL_TO", joinColumns = { @JoinColumn(name = "NMT_NODE") })
	@Field(index = Index.TOKENIZED, store = Store.YES)
	@FieldBridge(impl = SetFieldBridge.class)
	...
	@ElementCollection
	@Column(name = "NML_CC")
	@CollectionTable(name = "ikon_NODE_MAIL_CC", joinColumns = { @JoinColumn(name = "NMC_NODE") })
	@Field(index = Index.TOKENIZED, store = Store.YES)
	@FieldBridge(impl = SetFieldBridge.class)
	...
	@ElementCollection
	@Column(name = "NML_BCC")
	@CollectionTable(name = "ikon_NODE_MAIL_BCC", joinColumns = { @JoinColumn(name = "NMB_NODE") })
	@Field(index = Index.TOKENIZED, store = Store.YES)
	@FieldBridge(impl = SetFieldBridge.class)
