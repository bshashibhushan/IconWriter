...
@Entity
@Table(name = "ikon_AUTO_METADATA", uniqueConstraints={
		// ALTER TABLE ikon_AUTO_METADATA ADD CONSTRAINT IDX_AUTO_MD_ATCLS UNIQUE (AMD_AT, AMD_CLASS_NAME)
...
public class AutomationMetadata implements Serializable {
	...
	public static final String SOURCE_FOLDER = "openkm:folder";
