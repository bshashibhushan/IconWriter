...
@Entity
@Table(name="ikon_ACTIVITY")
@org.hibernate.annotations.Table(appliesTo="ikon_ACTIVITY",
		indexes = {
			// CREATE INDEX IDX_ACTIVITY_DATACT ON ikon_ACTIVITY(ACT_DATE, ACT_ACTION);
			@Index(name = "IDX_ACTIVITY_DATACT", columnNames = { "ACT_DATE", "ACT_ACTION" } ),
			// CREATE INDEX IDX_ACTIVITY_USRACT ON ikon_ACTIVITY(ACT_USER, ACT_ACTION);
...
public class Activity implements Serializable {
	...
	// CREATE INDEX IDX_ACTIVITY_DATE ON ikon_ACTIVITY(ACT_DATE);
