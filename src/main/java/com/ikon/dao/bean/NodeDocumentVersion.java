...
@Entity
@Indexed
@Table(name = "ikon_NODE_DOCUMENT_VERSION", uniqueConstraints = {
		@UniqueConstraint(name = "IDX_NOD_DOC_VER_PARNAM", columnNames = { "NDV_PARENT", "NDV_NAME" })})
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.hibernate.annotations.Table(appliesTo="ikon_NODE_DOCUMENT_VERSION",
		indexes = {
			// CREATE INDEX IDX_NOD_DOC_VER_PARCUR ON ikon_NODE_DOCUMENT_VERSION(NDV_PARENT, NDV_CURRENT);
...
public class NodeDocumentVersion implements Serializable {
	...
	// CREATE INDEX IDX_NDOC_VERSION_PARENT ON ikon_NODE_DOCUMENT_VERSION(NDV_PARENT);
