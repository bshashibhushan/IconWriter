...
public class ProfileToolbar implements Serializable {
	...
	private boolean annotateVisible;
	...
	public boolean isAnnotateVisible() {
		return annotateVisible;
	}

	public void setAnnotateVisible(boolean annotateVisible) {
		this.annotateVisible = annotateVisible;
	}
