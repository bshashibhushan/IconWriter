...
/**
 * Search results are filtered by com.ikon.module.db.stuff.ReadAccessFilterFactory, which limit the results only for
...
public class SearchDAO {
	...
	public NodeResultSet findBySimpleQuery(String expression, int offset, int limit) throws ParseException,
		...
		try {
			...
			QueryParser parser = new QueryParser(Config.LUCENE_VERSION, NodeDocument.TEXT_FIELD, new KeywordAnalyzer());
